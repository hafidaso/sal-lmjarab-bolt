...
import { Eye, EyeOff, Heart, Mail, Lock, User, Stethoscope, MapPin, Phone, Building } from 'lucide-react';
...
const DoctorRegistration = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // In a real app, we would also store the additional doctor information
      // in a separate table using the user's ID
      ...
      >
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Create your provider account to connect with patients
          </p>
        </div>
